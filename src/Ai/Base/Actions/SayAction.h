...
public:
    ...
    // Whisper a chat reply, unless the player only wrote in a channel and bots may not whisper players.
    static void WhisperReply(Player* bot, ChatChannelSource chatChannelSource, std::string& responseMessage,
                             std::string& name);
};
#endif
